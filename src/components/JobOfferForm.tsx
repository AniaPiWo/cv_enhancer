...
>(({ jobDescription, errorMessage, onChange, onSubmit }, ref) => (
  <form
    ref={ref}
    onSubmit={onSubmit}
  ...
  >
    ...
    <textarea
      name="jobDescription"
      className="gap-6 border border-slate-300 rounded-lg w-[650px] h-[188px] p-6 cursor-pointer bg-inherit resize-none flex-grow"
